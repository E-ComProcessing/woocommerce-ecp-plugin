 ...
 * @package     includes\blocks\class-wc-ecomprocessing-blocks-checkout
 */
...
/**
 * Ecomprocessing Blocks Checkout module
 */
final class WC_Ecomprocessing_Blocks_Checkout extends WC_Ecomprocessing_Blocks_Base {
	...
	public function initialize() {
		...
		$this->settings = $this->get_filtered_plugin_settings( 'woocommerce_ecomprocessing_checkout_settings' );
	}
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc-ecomprocessing-payments-blocks-checkout',
			$script_url,
		...
		return array( 'wc-ecomprocessing-payments-blocks-checkout' );
	}
