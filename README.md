\*CAUTION\* The e-comprocessing Gateway Module Plugin for WooCommerce is deprecated and will no longer receive updates.
=============================
...
* Using integrated WooCommerce Refund functionality
    ...
    You should choose the "Refund via ecomprocessing Checkout/Direct" button if you want to send that refund to the Genesis Gateway.
